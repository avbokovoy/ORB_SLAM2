...
{
public:
    ImageGrabber(ORB_SLAM2::System* pSLAM, const ros::NodeHandle& _nh)
    : mpSLAM(pSLAM),
      m_nodeHandler(_nh)
    {
        this->m_posePublisher = this->m_nodeHandler.advertise<geometry_msgs::PoseStamped>( "/mavros1/vision_pose/pose", 1000 );
    }
...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, "/camera_front1/image_raw1", 1);
    message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, "/camera_front2/image_raw2", 1);
...
void ImageGrabber::GrabStereo(const sensor_msgs::ImageConstPtr& msgLeft,const sensor_msgs::ImageConstPtr& msgRight)
{
    ...
    this->m_posePublisher.publish( poseStamped );
}
